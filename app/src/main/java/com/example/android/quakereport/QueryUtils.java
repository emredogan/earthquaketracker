    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0; i<featuresArray.length(); i++) {
                JSONObject earthquakeObject = (JSONObject) featuresArray.get(i);
                ...
                String detailUrl = (properties.getString("url")).toString();




                Earthquake earthquake = new Earthquake(mag,location,time,detailUrl);
